        ...
        <div className="container d-flex justify-content-center">
            <div className="card w-50">
                <div className="card-body">
                    ...
                    <a href="#" className="btn btn-primary" onClick={() => actions.getToken(email, password)}>Login</a>
                    <a href='#' className="btn btn-primary" onClick={() => actions.createUser(email, password)}>Sign Up</a>
                </div>
            </div>
        </div>
    )
